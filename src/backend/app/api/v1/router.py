...
from .endpoints.client_structured_data_store import router as client_structured_data_store_router
...
api_v1_router.include_router(client_structured_data_store_router)
